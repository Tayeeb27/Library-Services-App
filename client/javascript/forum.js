...
const createElement = (data) => {
    ...
    content.innerHTML = `<b>Content:</b> ${data['content']}`;
    ...
    dateP.innerHTML = `<b>Date:</b> ${formattedDate}`;
    book.appendChild(dateP);
    ...
    timeP.innerHTML = `<b>Time:</b> ${formattedTime}`;
    book.appendChild(timeP);
